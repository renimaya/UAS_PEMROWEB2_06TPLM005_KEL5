...
<head>
	<meta charset="utf-8">
	<title>UAS WEB 2 PEMESANAN MAKANAN - KEL.5 - 06TPLM005</title>
	 ...
	 <div class="container-fluid">
	 	<div class="row justify-content-center">
	 		<div id="bagianHeader" class="col-lg-12">
	 			<span id="headerText">Input Data Pemesanan Makanan</span>
            ...
            <div id="namaKelompok" class="col-lg-6">
                UAS PEMROGRAMAN WEB 2 ~ Kelompok 5 ~ 06TPLM005<br>
                Muhammad aprinaldi syah putra - 191011401761 <br>
                Rega Harto Pradana - 191011400815 <br>
                Naufal Daffa Reswara - 191011400509 <br>
                Reni Maya Anggraeni - 191011400288 <br>
                Muhammad arkaan maliek - 171011401461
            </div>
	 	</div>
	 </div>
